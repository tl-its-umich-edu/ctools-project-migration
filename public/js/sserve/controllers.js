...
projectMigrationApp
  .controller(
    'projectMigrationController', [
      ...
      '$window',
      '$http',
      function(Projects, ProjectsLite, Migration, Migrations, Migrated,
              ...
              function(result) {
                ...
                if (result.status === 200) {
                  ...
                  $log
                    .info(moment()
                      .format(
                        'h:mm:ss') + ' - migrating projects loaded');
                  $log
                    .info(' - - - - GET /migrating');
            ...
            function(result) {
              if (result.status === 200) {
                ...
                $log
                  .info(moment()
                    .format(
                      'h:mm:ss') + ' - migrated projects loaded');
                $log
                  .info(' - - - - GET /migrated');
                updateProjectsPanel(
                  $scope.migratedProjects,
            ...
            .then(
              function(result) {
                ...
                $log
                  .info(moment()
                    .format(
                      'h:mm:ss') + ' - tools requested for project ' + $scope.sourceProjects[targetProjPos].entityTitle + ' ( site ID: s' + projectId + ')');
                $log
                  .info(' - - - - GET /projects/' + projectId);
              });
        };
              ...
              .then(
                function(result) {
                  ...
                  $log
                    .info(moment()
                      .format(
                        'h:mm:ss') + ' - BOX folder info requested');
                  $log
            ...
            .then(
              function(result) {
                ...
                $log
                  .info(moment()
                    .format(
                      'h:mm:ss') + ' - unauthorize from Box account requested');
                $log
            ...
            .each(
              ...
              function(key, value) {
                  ...
                  Migration
                    ...
                    .then(
                      function(
                        ...
                        $log
                          .info(' - - - - POST ' + migrationUrl);
                        $log
                          .warn(' - - - - after POST we start polling for /migrations every ' + $rootScope.pollInterval / 1000 + ' seconds');
                      });
                } else {
                  // download locally
                ...
                $log
                  .warn(moment()
                    .format(
                      'h:mm:ss') + ' - project migration started for ' + migrationUrl);
              });
        };
            ...
            .startPolling(
              ...
              function(result) {
                $log.info(moment().format(
                  'h:mm:ss') + ' polled: ' + pollName + ' for ' + url);
        ...
        var updateProjectsPanel = function(result, source) {
          $log
            .info('updating projects panel because of changes to /' + source);
          if (source === 'migrating') {
                ...
                .each(
                  ...
                  function(sourceProject) {
                    if (sourceProject !== null && sourceProject !== undefined) {
                      ...
                      if (projectMigrating) {
                        $log
                          .warn('locking ' + sourceProject.site_name);
